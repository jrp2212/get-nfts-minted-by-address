...
4. Open `get_nfts_minted_by_address_.js` and update the value of the Wallet Address found within the main function to reflect the wallet that you will be querying.
...
7. Run the script in the terminal: `node get_nfts_minted_by_address_.js`
